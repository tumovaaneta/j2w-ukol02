...
public class MainController {
    ...
    public ModelAndView citat() throws IOException {
        int nahodnyPoradiCitatu = random.nextInt(8);
        int nahodnyPoradiObrazku = random.nextInt(8);
        ...
        result.addObject("citat", citaty.get(nahodnyPoradiCitatu));
        result.addObject("obrazek", obrazky.get(nahodnyPoradiObrazku));
        return result;
    }
